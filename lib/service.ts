...
export default class Service {
  ...
  public async read<Name extends Keys, Value = Values<Name>>(
    name: Name
  ): Promise<Value> {
    this.ensureLoaded();
  ...
  public async write<Name extends Keys, Value = Values<Name>>(
    name: Name,
    value: Value
  ): Promise<void> {
    this.ensureLoaded();
  ...
  public on<Name extends Keys>(
    name: Name,
    listener: (value: Values<Name>) => void
  ): void {
    throw new Error("Not implemented yet");
  }

  public off<Name extends Keys>(
    name: Name,
    listener?: (value: Values<Name>) => void
  ): void {
    throw new Error("Not implemented yet");
